...
def initial_slambook():
    ...
    for i in range(row):
        ...
        hobbies = str(input("Enter your hobbies: ")) or None
        temp.append(hobbies)
        
        favorites = str(input("Enter your favorite color, animal, number, sport, B.F.F, and grade: ")) or None
        temp.append(favorites)
        
        opinion = str(input("Enter something you hate and like about the person who made this slam book: ")) or None
        temp.append(opinion)
